...
Cool temps 16 days ago are good though?  Less data out past 15 days because of weird data structure.  I think it might be best to cut off predictions or extend lag...
...
```
Not much of a pattern with max temp.  I guess low temp 8 days ago.
...
Once patchwork is working again, do this:
...
ggsave(here("figs", "hopper_crossbasis.png"))
```
