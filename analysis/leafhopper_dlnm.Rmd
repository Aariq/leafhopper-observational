...
According to plot of full model, 10 days of lag has steepest slope
...
## H3: Is there an effect of min temp 11 days prior to observation?

According to plot of full model, 11 days of lag has steepest slope, if you don't count the area not well supported by data.
