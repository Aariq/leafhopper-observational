...
The precipitation model has the lowest AIC
...
### Generate data
```{r}
st_pd <- pred_shoots(Q = Q_temp, L = L, df = shootdf, colname = "temp_mean",
                     model = m_shoot_temp)
stmin_pd <- pred_shoots(Q = Q_min_temp, L = L, df = shootdf, colname = "temp_min",
                     model = m_shoot_min_temp)
stmax_pd <- pred_shoots(Q = Q_max_temp, L = L, df = shootdf, colname = "temp_max",
                     model = m_shoot_max_temp)
sp_pd <- pred_shoots(Q = Q_precip, L = L, df = shootdf, colname = "precip_mm",
