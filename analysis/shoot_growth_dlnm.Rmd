...
**Do i need to include time (date) as a smooth term?  To control for temporal autocorrelation?  Look in Gasparrini again**

Do separate models for temp and precip and compare with qAIC to see which one is best.
