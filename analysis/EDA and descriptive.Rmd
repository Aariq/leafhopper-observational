...
```{r}
plot1 <- precip_plot/temp_plot/densityplot + plot_layout(heights = c(2,2,3.5)) + plot_annotation(tag_levels = "A") &
  theme(text = element_text(size = 9))
ggsave(here("figs", "exploratory.png"), plot1, width = 165, height = 150, units = "mm")
