...
hoppers7 <- 
  ...
  select(date_time, date, day, day_post, field, interharvest_id, plant, counter, hoppers, n_leaves, temp_at_count, starts_with("temp_"), starts_with("precip"), starts_with("L"))
```
