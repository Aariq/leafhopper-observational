...
Because of the missing values in the temperature data, I think I'll just limit my dataset to only include things 15 days after those NAs.

```{r}
shoot_data_full <- shoot_data_full %>% filter(date > ymd("2017-06-09"))
```
